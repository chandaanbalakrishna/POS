...
const ProjectScreen: React.FC = () => {
  ...
  const onSelect = async (data: Project) => {
    debugger
    navigation.navigate("USList", { ProjectId: data.id, Name:"upload", CategoryIds: undefined, isUIApplicable: undefined, CategoryName:undefined, subCategoryName:undefined});
